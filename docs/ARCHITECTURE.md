...
The MVP database has two tables:

- `tenders`: primary tender records and `analysis_json` payloads.
- `uploads`: uploaded PDF metadata linked to a tender.
...
6. Let the frontend switch from static JSON to the API repository implementation.
