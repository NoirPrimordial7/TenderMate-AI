        ...
        <div className="min-w-0">
          ...
          <p className="mt-2 text-sm leading-6 text-gray-600">
            {isFailed
              ...
              : "This will read the stored PDF page by page and save text for the future Gemini analysis step."}
          </p>
        </div>
      </div>
