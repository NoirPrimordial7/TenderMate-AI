  ...
  return (
    <form onSubmit={handleSubmit} className="te-form" noValidate>
      <div className="te-form-heading">
        <h2>Welcome back.</h2>
        <p className="te-form-subtitle">Sign in to analyse a new tender or return to an earlier decision.</p>
      </div>
      ...
      <PasswordField label="Password" autoComplete="current-password" value={password} onChange={(event) => setPassword(event.target.value)} required />
